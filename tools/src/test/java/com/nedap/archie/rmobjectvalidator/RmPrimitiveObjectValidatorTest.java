...
public class RmPrimitiveObjectValidatorTest {
    ...
    public void testCIntegerValidate() {
        ...
        List<RMObjectValidationMessage> result = validator.validate(rmObjects, ValidationPath.ROOT.joinPaths("/path/so/far"), cInteger);
    ...
    public void testCIntegerValidate_inner() {
        ...
        List<RMObjectValidationMessage> result = validator.validate_inner(-4L, ValidationPath.ROOT.joinPaths("/path/so/far"), cInteger);
